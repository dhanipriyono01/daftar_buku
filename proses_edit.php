  ...
  if($gambar!= "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
      move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru);   
        $query  = "UPDATE perpus SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', gambar = '$gambar'";
        $query .= "WHERE id = '$id'";
      ...
      $query  = "UPDATE perpus SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit',";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
